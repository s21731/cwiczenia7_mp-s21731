...
namespace Cw07.Models
{
    public partial class CUSERSZENEKDOCUMENTSDATABASEAPBDMDFContext : DbContext
    {
        public CUSERSZENEKDOCUMENTSDATABASEAPBDMDFContext()
        {
        }

        public CUSERSZENEKDOCUMENTSDATABASEAPBDMDFContext(DbContextOptions<CUSERSZENEKDOCUMENTSDATABASEAPBDMDFContext> options)
            : base(options)
        {
        }
